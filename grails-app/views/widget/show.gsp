...
<html>
    ...
    <body>
        ...
        <div id="show-widget" class="content scaffold-show" role="main">
            ...
            <f:display bean="widget" />
            <g:form resource="${this.widget}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.widget}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
